tinymce.ThemeManager.add("modern", function (e) {
    function t() {
        ...
        for (var i = 1; 10 > i && t(u["toolbar" + i]); i++);
        return n.length || u.toolbar === !1 || t(u.toolbar || f), n.length ? {type: "panel", layout: "stack", classes: "toolbar-grp", ariaRoot: !0, ariaRemember: !0, items: n} : void 0
    }
    ...
    function a(o) {
        function r() {
            if (h && h.moveRel && h.visible() && !h._fixed) {
                ...
                h.fixed(!1).moveRel(n, e.rtl ? ["tr-br", "br-tr"] : ["tl-bl", "bl-tl"]).moveBy(i, o)
            }
        }
    ...
    l.renderUI = function (t) {
        ...
        if (n) {
            var i = u.skin_url;
            i = i ? e.documentBaseURI.toAbsolute(i) : tinymce.baseURL + "/skins/" + n, t.skinUiCss = tinymce.Env.documentMode <= 7 ? i + "/skin.ie7.min.css" : i + "/skin.min.css", e.contentCSS.push(i + "/content" + (e.inline ? ".inline" : "") + ".min.css")
        }
