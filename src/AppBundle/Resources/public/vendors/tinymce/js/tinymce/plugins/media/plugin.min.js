tinymce.PluginManager.add("media", function (e, t) {
    ...
    function o() {
        ...
        var i, r, o, m, u = [
            {name: "source1", type: "filepicker", filetype: "media", size: 40, autofocus: !0, label: "Source"}
        ];
        ...
        ]}), m = n(e.selection.getNode()), r = m.width, o = m.height, i = e.windowManager.open({title: "Insert/edit video", data: m, bodyType: "tabpanel", body: [
    ...
    function c(o) {
        ...
        if (o.source2 || (o.source2 = ""), o.poster || (o.poster = ""), o.source1 = e.convertURL(o.source1, "source"), o.source2 = e.convertURL(o.source2, "source"), o.source1mime = i(o.source1), o.source2mime = i(o.source2), o.poster = e.convertURL(o.poster, "poster"), o.flashPlayerUrl = e.convertURL(t + "/moxieplayer.swf", "movie"), o.embed)a = m(o.embed, o, !0); else {
            tinymce.each(u, function (e) {
                var t, i, r;
    ...
    function m(e, t, i) {
        function r(e, t) {
            var i, r, o, a;
            for (i in t)if (o = "" + t[i], e.map[i])for (r = e.length; r--;)a = e[r], a.name == i && (o ? (e.map[i] = o, a.value = o) : (delete e.map[i], e.splice(r, 1))); else o && (e.push({name: i, value: o}), e.map[i] = o)
        }
        ...
        return new tinymce.html.SaxParser({validate: !1, allow_conditional_comments: !0, special: "script,noscript", comment: function (e) {
            ...
            if (i)switch (e) {
                ...
                case"iframe":
                    ...
                    break;
                case"source":
                    if (c++, 2 >= c && (r(s, {src: t["source" + c], type: t["source" + c + "mime"]}), !t["source" + c]))return;
                    break;
                case"img":
                    if (!t.poster)return;
                    o = !0
            ...
            if ("video" == e && i)for (var s = 1; 2 >= s; s++)if (t["source" + s]) {
                var n = [];
                n.map = {}, s > c && (r(n, {src: t["source" + s], type: t["source" + s + "mime"]}), a.start("source", n, !0))
            }
    ...
    e.on("ResolveName", function (e) {
        ...
        tinymce.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
            ...
            for (var o, a, c, s, n, m, u, d, l = t.length; l--;)if (a = t[l], "script" != a.name || (d = r(a.attr("src")))) {
            ...
            for (var i, r, o, a, c, s, n, m = e.length; m--;) {
                for (i = e[m], n = i.attr(t), r = new tinymce.html.Node(n, 1), "audio" != n && "script" != n && r.attr({width: i.attr("width"), height: i.attr("height")}), r.attr({style: i.attr("style")}), a = i.attributes, o = a.length; o--;) {
                    var u = a[o].name;
        ...
        var t, i = e.target;
        i.getAttribute("data-mce-object") && (t = i.getAttribute("data-mce-html"), t && (t = unescape(t), i.setAttribute("data-mce-html", escape(m(t, {width: e.width, height: e.height})))))
