tinymce.PluginManager.add("directionality", function (t) {
    ...
    t.addCommand("mceDirectionLTR", function () {
        ...
        e("rtl")
    }), t.addButton("ltr", {title: "Left to right", cmd: "mceDirectionLTR", stateSelector: i("ltr")}), t.addButton("rtl", {title: "Right to left", cmd: "mceDirectionRTL", stateSelector: i("rtl")})
});